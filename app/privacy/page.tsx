      ...
      <article className="mx-auto max-w-2xl rounded-xl border border-zinc-200 bg-white p-6 md:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7">
          <section>
            ...
            <p className="mt-2">みんなでピックル！！は、アカウント登録時のメールアドレス、表示名、都道府県、競技レベル、ユーザーが投稿した募集内容および参加情報を取得します。参加・応募時には、氏名、レベル、参加人数、パドル・ネット・ボールの有無、選択した連絡方法と連絡先を取得します。通報時には通報理由と詳細、お問い合わせ時には氏名、返信用メールアドレス、お問い合わせ内容を取得します。Googleログインを利用した場合は、Googleから提供される氏名、メールアドレスなどの基本プロフィール情報を取得します。</p>
          ...
          <section>
            ...
            <p className="mt-2">本人確認、ログイン状態の維持、募集の投稿・参加・承認管理、参加者と主催者の連絡、地域に応じた情報表示、通報対応、不正利用の防止、サービス改善およびお問い合わせ対応のために利用します。応募時の連絡先は応募先の主催者と管理者だけに表示します。</p>
          </section>
          <section>
