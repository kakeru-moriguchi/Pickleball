      ...
      <article className="mx-auto max-w-2xl rounded-xl border border-zinc-200 bg-white p-6 md:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7">
          ...
          <section>
            ...
            <p className="mt-2">投稿者は募集内容、日時、場所、参加費などを正確に記載してください。応募は主催者の承認によって参加確定となります。アプリ内メッセージは、募集に関する連絡のためにのみ使用してください。参加者と主催者の間で発生する連絡、費用の支払い、事故やトラブルについては、当事者間で解決するものとします。</p>
          </section>
          <section>
